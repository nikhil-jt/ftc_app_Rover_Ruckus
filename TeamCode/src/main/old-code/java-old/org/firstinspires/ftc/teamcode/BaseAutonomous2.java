...
public abstract class BaseAutonomous2 extends LinearOpMode {
    ...
    protected DcMotor leftwheel = null; //Inits the object to null
    protected DcMotor right = null; //Inits the object to null
    protected DcMotor rightwheel = null; //Inits the object to null
...
//        leftwheel.setDirection(DcMotorSimple.Direction.REVERSE); //Reverses one motor or else they would be spinning opposite directions
        jewelservo.setPosition(0); //Raises the servo slightly
...
//        TODO adjust 2.0 - since it is a guess
        vuforiaMove((VuforiaTrackableDefaultListener) relicTemplate.getListener(), 1.4, 20);
