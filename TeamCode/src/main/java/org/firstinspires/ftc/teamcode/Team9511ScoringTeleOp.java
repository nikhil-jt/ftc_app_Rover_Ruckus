...
@Disabled
@TeleOp(name = "Team9511ScoringTeleOp", group = "Iterative Opmode")
public class Team9511ScoringTeleOp extends OpMode {
    ...
    public void loop() {
        ...
        y = b ? -y : y;
        double multiplier = gamepad1.left_trigger > 0.1 ? 0.5 : 1;
        multiplier = gamepad1.right_trigger > 0.1 ? multiplier / 2 : multiplier;
        ...
        intake.setPosition(gamepad1.left_bumper ? 0.04 : (gamepad1.right_bumper ? 0.94 : 0.5));
